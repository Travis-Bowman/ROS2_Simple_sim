...
from simple_sim.cfg import SimpleSimConfig
...
class RobotTester():
    def __init__(self):
        ...
        client = dynamic_reconfigure.client.Client("simple_sim",
                                                   timeout=30,
                                                   config_callback=self.dynamic_reconfig_callback)
        
        #srv = Server(SimpleSimConfig, self.dynamic_reconfig_callback)
    ...
    def dynamic_reconfig_callback(self, config):
